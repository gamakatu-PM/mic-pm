...
def check(base, log):
    ...
    # v46 진행중 + 만들기 먼저 여쭙기 + 미룸 값
    ok('48 한 줄 해석 : KM-001 진행중 → 진행중', (_RP.parse_line('KM-001 진행중') or ['', ''])[1] == '진행중')
    ok('48 한 줄 해석 : 2 보냈어 → 진행중', (_RP.parse_line('2 보냈어') or ['', ''])[1] == '진행중')
    ok('48 : 「진행중」 이 「진행」(맞아) 보다 먼저 걸린다', (_RP.parse_line('3 진행 중이야') or ['', ''])[1] == '진행중')
