...
try:
    ...
    chk('없는 53번 새로 넣음', '없음 → v3' in n2, n2)
    ...
    chk('넣은 53번이 진짜 v3', "VERSION = 'v3" in src and 'def run_range' in src)
    ...
    chk('할 일 줄 + 시트 링크', '2026-09-15\t앵커 호텔\t도면 제출  (기한 2026-09-20)  (배성윤 → 김경원 상무)' in todo and '26년 할 일 모음 : https://docs.google.com/spreadsheets/d/1S02' in todo, todo)
